...
module.exports = {
    ...
    createDatabase: () => {
        this.connection.query("CREATE DATABASE `rspcahhb` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;",  function(err,result){
            if (err) throw err;
